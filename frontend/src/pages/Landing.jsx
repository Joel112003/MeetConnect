...
const Tile = ({ initials, name, gradFrom, gradTo, textCol, isSpeaking, delay, badge }) => (
  ...
  >
    <div className={`flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br ${gradFrom} ${gradTo} text-[13px] font-bold ${textCol}`}
    ...
    {isSpeaking && (
      <div className="absolute bottom-2 left-2.5 flex items-end gap-[2px] h-3.5">
        {[5, 10, 7, 13].map((h, i) => (
          <div key={i} className="w-[3px] rounded-sm bg-blue-400"
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-[#03080f] text-white"
      ...
      <div className="pointer-events-none fixed inset-0 z-0 overflow-hidden">
        <div className="absolute left-1/2 top-[-200px] h-[660px] w-[660px] -translate-x-1/2 rounded-full animate-pulse"
          style={{ background: "radial-gradient(circle, rgba(37,99,235,0.17) 0%, transparent 65%)", animationDuration: "4s" }} />
        <div className="absolute bottom-[-60px] right-[-80px] h-[400px] w-[400px] rounded-full"
      ...
      {/* ── Header ── */}
      <header
        className="fixed inset-x-0 top-0 z-50 flex h-16 items-center justify-between border-b border-white/[0.06] bg-[#03080f]/85 px-10 backdrop-blur-xl"
        style={{ animation: "slideDown 0.55s cubic-bezier(0.22,1,0.36,1) both" }}
      >
        <button onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}
          className="flex items-center gap-2.5">
          <span className="flex h-[34px] w-[34px] items-center justify-center overflow-hidden rounded-[9px] border border-white/10 bg-white/[0.04]">
            <img src={meetConnectLogo} alt="MeetConnect" className="h-full w-full scale-[2] object-contain" />
          </span>
        ...
        <div className="flex items-center gap-1.5">
          <button onClick={() => navigate("/login")}
            className="rounded-lg px-4 py-1.5 text-sm font-medium text-white/45 transition-all hover:bg-white/[0.05] hover:text-white">
            Sign in
          </button>
          <button onClick={() => navigate("/signup")}
            className="rounded-[9px] bg-blue-600 px-5 py-[7px] text-sm font-semibold text-white transition-all hover:bg-blue-500 hover:-translate-y-px active:scale-95"
            style={{ boxShadow: "0 2px 16px rgba(37,99,235,0.35)" }}>
            Get started
          </button>
        </div>
      </header>
      ...
      <main className="relative z-10 flex min-h-screen items-center pt-16">
        <div className="mx-auto grid w-full max-w-[1180px] grid-cols-2 items-center gap-16 px-10 py-20">
          ...
          <div style={{ animation: "fadeUp 0.7s 0.1s cubic-bezier(0.22,1,0.36,1) both" }}>
            ...
            <h1 className="mb-5 leading-[0.93] tracking-[-0.04em]"
              style={{ fontFamily: "'Syne',sans-serif", fontWeight: 800, fontSize: "clamp(46px,5.4vw,72px)" }}>
              Meetings
              <br />
              that{" "}
            ...
            <p className="mb-9 max-w-[390px] text-[14.5px] leading-relaxed text-white/38 font-light">
              Crystal-clear calls, enterprise-grade security, and instant room joins
              from any browser — no downloads required.
            </p>
            ...
            <div className="flex items-stretch gap-8">
              {[["50M+","Users"],["99.9%","Uptime"],["150+","Countries"]].map(([n,l],i) => (
                <React.Fragment key={l}>
                  ...
                  <div>
                    <p className="text-[22px] font-bold tracking-tight" style={{ fontFamily: "'Syne',sans-serif" }}>{n}</p>
          ...
          {/* Mock meeting UI */}
          <div className="relative" style={{ animation: "fadeUp 0.7s 0.25s cubic-bezier(0.22,1,0.36,1) both" }}>
            ...
            <div
              ...
              style={{ animation: "floatIn 0.5s 0.65s cubic-bezier(0.22,1,0.36,1) both, bob 4.5s 1.8s ease-in-out infinite", boxShadow: "0 8px 32px rgba(0,0,0,0.5)" }}
            >
              <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-emerald-600 to-emerald-800 text-[10px] font-bold text-emerald-100"
                style={{ fontFamily: "'Syne',sans-serif" }}>MR</div>
              <div>
            ...
            <div
              ...
              style={{ animation: "floatIn 0.5s 0.85s cubic-bezier(0.22,1,0.36,1) both, bob 5s 2.2s ease-in-out infinite", boxShadow: "0 8px 32px rgba(0,0,0,0.5)" }}
            >
            ...
            >
              ...
              <div className="mb-3.5 flex items-center justify-between">
                <span className="text-[13px] font-semibold text-white/45" style={{ fontFamily: "'Syne',sans-serif" }}>
                  Design Review · 4B
                </span>
              ...
              <div className="mb-3.5 flex h-7 items-center justify-between gap-3 overflow-hidden rounded-lg border border-white/[0.05] bg-white/[0.025] px-3">
                <div className="flex items-end gap-[3px] h-4">
                  {[4,9,6,13,5,10,12,6].map((h,i) => (
                    <div key={i} className="w-[3px] rounded-sm bg-blue-400/60"
              ...
              <div className="mb-3.5 grid grid-cols-2 gap-2.5">
                <Tile initials="AK" name="Alex Kim"   gradFrom="from-blue-900"   gradTo="to-blue-600"   textCol="text-blue-200"   isSpeaking delay={0.38}
                  badge={<MicIcon stroke="#60a5fa" />} />
                <Tile initials="SR" name="Sara R."    gradFrom="from-emerald-900" gradTo="to-emerald-600" textCol="text-emerald-200" delay={0.46}
                  badge={<MutedMic />} />
                <Tile initials="JP" name="James P."   gradFrom="from-violet-900" gradTo="to-violet-600" textCol="text-violet-200"  delay={0.54}
                  badge={<CamIcon stroke="rgba(200,200,255,0.25)" />} />
                <Tile initials="LN" name="Luna N."    gradFrom="from-orange-900" gradTo="to-orange-600" textCol="text-orange-200"  delay={0.62}
                  badge={<span className="text-base animate-bounce" style={{ animationDuration:"2.2s" }}>👍</span>} />
              </div>
              ...
              <div className="flex items-center justify-center gap-2">
                {[
                  ...
                  { icon: (
                    ...
                    </svg>), cls: "border-red-500/20 bg-red-500/12 hover:bg-red-500/22" },
                  { icon: <MoreIcon />, cls: "border-white/[0.07] bg-white/[0.04] hover:bg-white/[0.09]" },
                ].map((b,i) => (
                  <button key={i} className={`flex h-10 w-10 items-center justify-center rounded-[10px] border transition-all duration-150 hover:scale-105 active:scale-95 ${b.cls}`}>
                    {b.icon}
                  </button>
                ))}
              </div>
